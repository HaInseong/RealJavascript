...
})({"41f0F":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "253380c5ea9ab0b4";
"use strict";
...
},{}],"aGsu3":[function(require,module,exports) {
/**
 * Section 5 start
 * Lecture 1
 */ /**
...
console.log([
    ...
    3,
    -1
].indexOf(-2)); // indexOf는 값이 없음을 -1로 표현, 이유는? js에서 배열은 0부터 시작하기 때문에 음수가 될 수 없다.
...
const result = [
    ...
    3,
    -1
].find((it)=>it === 2); // find함수: 값을 찾아서 있으면 값을 반환
...
// x % n => 0 ~ n-1
console.log(0);
for(let i = 0; i < 10; i++)if (i % 3 === 0) console.log(i, "3\uC758 \uBC30\uC218\uC774\uBA74 \uC5B4\uB5A4 \uC77C\uC744 \uD55C\uB2E4.");
let items = [
    "a",
    "b",
    "c"
...
},{}]},["41f0F","aGsu3"], "aGsu3", "parcelRequire17a1")

//# sourceMappingURL=index.ea9ab0b4.js.map
